...
class AMD:
    ...
    def __init__(self, fexp: str, mnames: list = []):
        ...
        Args:
            fexp (str): Experimental asymmetries filename.
        ...
        Notes:
            * `fexp` file must present *hkl* indices, asymmetry type, and diffraction geometry in columns (this order),
                  including primary reflection and X-ray energy in 1st line. This file is automatic generated by the
                  `expdata` class (*.red*).
        """
    ...
    def experimental_asymmetries(self, hl: str or tuple = 'cyan', lh: str or tuple = 'gold'):
        ...
        """Diagram of experimental asymmetries.
    ...
    def diagram_positions(self):
        ...
        """MD positions in the asymmetry matching diagram."""
    ...
    def onevariable_plot(self, ncols: int, nrows: int, color_empty: str or tuple = 'whitesmoke',
        ...
        """Plots the asymmetry matching diagram (AMD) for the structural models with one variable.
